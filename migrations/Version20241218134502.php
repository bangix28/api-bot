 ...
 */
final class Version20241218134502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history_account_lol (id INT AUTO_INCREMENT NOT NULL, riot_account_id_id INT NOT NULL, data JSON DEFAULT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C63CEF7AB55FC8E8 (riot_account_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE history_account_lol ADD CONSTRAINT FK_C63CEF7AB55FC8E8 FOREIGN KEY (riot_account_id_id) REFERENCES riot_account (id)');
    }
